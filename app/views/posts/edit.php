        ...
        <div class="card bg-light mt-5">
            <div class="card-header card-text">
                <div class="row">
                    ...
                    <div class="col">
                        <a href="<?php echo URL ;?>/posts/index" class="btn btn-light pull-right"><i class="fa fa-backward"></i> Back</a>
                    </div>
            ...
            <div class="card-body">
                <form method="post" action="<?php echo URL ;?>/Posts/edit/<?php echo $data['id'] ;?>">
