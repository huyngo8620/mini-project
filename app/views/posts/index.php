<?php require APP . '/views/inc/header.php'; ?>
  ...
  <div class="row ">
      ...
      <div class="col-md-4">
          <a class="btn btn-primary pull-right" href="<?php echo URL ;?>/posts/add"><i class="fa fa-pencil"></i> Add Post</a>
      </div>
  </div>
  <?php foreach ($data['posts'] as $post) : ?>
        <div class="card mb-3 mt-2">
            ...
            <a href="<?php echo URL ;?>/posts/show/<?php echo $post->postId ;?>" class="btn btn-dark btn-block">View...</a>
        </div>
  <?php endforeach ;?>
